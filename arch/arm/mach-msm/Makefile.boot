...
initrd_phys-$(CONFIG_MACH_PICO)	:= 0x13C00000
   zreladdr-$(CONFIG_MACH_GOLFU)	:= 0x13208000
params_phys-$(CONFIG_MACH_GOLFU)	:= 0x13200100
initrd_phys-$(CONFIG_MACH_GOLFU)	:= 0x14200000
   zreladdr-$(CONFIG_MACH_PRIMODD)	:= 0x13608000
params_phys-$(CONFIG_MACH_PRIMODD)	:= 0x13600100
initrd_phys-$(CONFIG_MACH_PRIMODD)	:= 0x14600000
...
initrd_phys-$(CONFIG_MACH_BLISS)	:= 0x05400000
   zreladdr-$(CONFIG_MACH_PRIMOU)	:= 0x03F08000
params_phys-$(CONFIG_MACH_PRIMOU)	:= 0x03F00100
initrd_phys-$(CONFIG_MACH_PRIMOU)	:= 0x04F00000
   zreladdr-$(CONFIG_MACH_PRIMOC)	:= 0x15008000
params_phys-$(CONFIG_MACH_PRIMOC)	:= 0x15000100
initrd_phys-$(CONFIG_MACH_PRIMOC)	:= 0x16000000
...
# MSM8x60
   zreladdr-$(CONFIG_ARCH_MSM8X60)	:= 0x40A08000
   params_phys-$(CONFIG_ARCH_MSM8X60)	:= 0x40A00100
   initrd_phys-$(CONFIG_ARCH_MSM8X60)	:= 0x41A00000
